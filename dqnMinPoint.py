from objectives.MinPointDistance import MinDistance
from objectives.sgdopenaiMinPoint import StochasticGradientEnvironment
...
class SGDDQNAgent:
    def __init__(self):
        ...
        self.optimal_w = self.objective.analytical_solution()
